    ...
    <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      ...
      >
        ...
        <div className="flex items-center flex-shrink-0">
           <a href="mailto:rizkifadhilahmhabibi@gmail.com" className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#1c1c1c] border border-[#262627] hover:border-gray-500 transition-colors">
              <span className="font-mono text-xs font-bold text-morva-accent">rizkifadhilahmhabibi@gmail.com</span>
           </a>
        </div>
      </motion.header>
    </div>
