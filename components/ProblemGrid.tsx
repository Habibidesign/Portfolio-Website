...
const SkillCard: React.FC<{ title: string; level: string; color: string }> = ({ title, level, color }) => (
  <div className="p-1 rounded-[24px] bg-[#1c1c1c] flex-shrink-0">
    <div className={`h-full bg-[#080808] border border-[#262627] rounded-[20px] p-6 w-[280px] flex flex-col justify-between relative overflow-hidden group hover:border-[${color}]/50 transition-colors`}>
...
const ProblemGrid: React.FC = () => {
  return (
    <section className="py-24 bg-morva-bg border-t border-[#1c1c1c] overflow-hidden">
