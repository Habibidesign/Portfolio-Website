...
const Hero: React.FC = () => {
  return (
    <section className="relative pt-48 pb-20 flex flex-col justify-center items-center bg-morva-bg overflow-hidden text-center px-4 min-h-[90vh]">
      ...
      <div className="max-w-5xl mx-auto mb-10 relative z-10">
        <motion.h1 
          className="font-sans font-bold text-6xl md:text-8xl lg:text-[100px] leading-[0.95] tracking-tight text-white mb-2"
        ...
        <motion.h1 
           className="font-sans font-bold text-6xl md:text-8xl lg:text-[100px] leading-[0.95] tracking-tight text-gradient-morva pb-2"
           initial={{ opacity: 0, y: 30 }}
           animate={{ opacity: 1, y: 0 }}
      ...
      >
        <a 
          href="#experience"
          className="btn-gradient-primary px-8 py-4 rounded-full font-bold text-sm hover:scale-105 transition-transform duration-200 shadow-xl shadow-blue-500/10"
        >
          View Experience
        </a>
        ...
        <a 
          ...
          className="btn-gradient-dark px-8 py-4 rounded-full border border-[#262627] text-white font-bold text-sm hover:bg-white/5 transition-colors duration-200 flex items-center gap-2"
        >
          Hire Me
        </a>
      </motion.div>
