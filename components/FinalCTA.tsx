...
const FinalCTA: React.FC = () => {
  return (
    <section className="py-24 px-6 bg-morva-bg flex justify-center">
      <div className="w-full max-w-5xl bg-gradient-to-b from-[#1c1c1c] to-[#0d0d0d] rounded-[32px] p-12 md:p-20 text-center relative overflow-hidden border border-[#262627]">
